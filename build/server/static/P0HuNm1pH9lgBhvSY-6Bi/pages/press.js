...
module.exports = __webpack_require__("U2yE");
...
class Press extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  async getNextPage() {
    ...
    var newData = await _sanity_client_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "b"].fetch(query, {}); // Construct secondaryDetail
  ...
  render() {
    ...
    var clips = data.map(itemData => __jsx(_components_Document_js__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      data: itemData,
      image: "heroImage",
      headline: "title",
      body: "body",
    ...
    var ArchiveItems = this.props.allClips.map(itemData => __jsx(next_link__WEBPACK_IMPORTED_MODULE_9___default.a, {
    ...
    return __jsx("div", null, __jsx("title", null, "PDP"), __jsx(_components_Header_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
      CurrentPage: "Press"
    }), clips, __jsx(_components_Sidebar_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], {
      headline: "Archive"
...
Press.getInitialProps = async function (context) {
  ...
  var data = await _sanity_client_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "b"].fetch(query, {}); // Construct secondaryDetail
  ...
  var allClips = await _sanity_client_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "b"].fetch(query, {});
  return {
    data: data,
