...
var external_react_textfit_ = __webpack_require__("21kQ");

// EXTERNAL MODULE: ./styles/projectList.sass
var projectList = __webpack_require__("Vorx");
...
class ProjectList_ProjectList extends external_react_default.a.Component {
  constructor() {
    super();
  ...
  render() {
    ...
    var Items = data.slice(0, this.props.limit).map(function (itemData) {
      return __jsx("li", null, __jsx(link_default.a, {
        href: '/project/' + itemData.slug.current
      }, __jsx("div", {
        className: "Project"
      }, __jsx("img", {
      ...
      }, __jsx("h1", null, itemData.title), __jsx("div", {
        className: "Stripe"
      })))));
    });
    return __jsx("ul", {
...
// EXTERNAL MODULE: ./styles/projects.sass
var projects = __webpack_require__("kbiy");
...
const getData = async function () {
  ...
  var data = await sanity_client["b" /* default */].fetch(query, {});
  return {
    data: data
  };
};
