...
module.exports = __webpack_require__("XB3I");
...
// EXTERNAL MODULE: ./styles/project.sass
var styles_project = __webpack_require__("fhoC");

// CONCATENATED MODULE: ./sanity-tools.js
...
// CONCATENATED MODULE: ./pages/project/[slug].js
...
class _slug_Project extends external_react_default.a.Component {
  render() {
    return _slug_jsx("div", null, _slug_jsx("title", null, "PDP"), _slug_jsx(Header["a" /* default */], {
      CurrentPage: "Project"
    }), _slug_jsx("div", {
      id: "project-body"
    }, _slug_jsx("div", {
      ...
      src: Object(helperFunctions["a" /* SanityImageUrl */])(this.props.project.image, {
        w: 1500,
        h: 750
      })
    })), _slug_jsx("div", {
      id: "ProjectTitle"
    }, _slug_jsx("h1", null, this.props.project.title), _slug_jsx("div", {
      id: "Stripe"
    }))), _slug_jsx("div", {
      id: "project-description"
    }, _slug_jsx(BlockContent, {
    ...
    }, this.props.relatedEvents.length > 0 ? 'Related Events:' : ''), _slug_jsx(DocumentList["a" /* default */], {
    ...
    }, this.props.relatedPress.length > 0 ? 'Related Press:' : ''), _slug_jsx(DocumentList["a" /* default */], {
...
_slug_Project.getInitialProps = async function (context) {
  ...
  var relatedPress = await sanity_client["b" /* default */].fetch(query, {});
...
/* harmony default export */ var _slug_ = __webpack_exports__["default"] = (_slug_Project);
